...
const int MAX_BACKOFF_TIME = 100;       // Maximum backoff time in ms
...
const int PACKET_SIZE = 1024;          // Packet size
const int MAX_RETRIES = 5;             // Maximum number of retries
const int CSI_PACKET_SIZE = 200;       // Size of CSI packet in WIFI 5
